...
{
        char * doc_id = "?documentId=configuracion";
        int tamanio =  strlen(doc_id) + strlen(FIRESTORE_URL)  + strlen(configuration.UUID) + strlen(configuration.MAC) + 3;
